...
export function Header({
  ...
  return (
    <header className="sticky top-1 w-[max(90%,1400px)] rounded-[30px] mx-auto z-40 bg-transparent overflow-hidden">
      <GlassSurface
      ...
      >
        <div className="relative w-full px-4 sm:px-6 lg:px-8">
          <div className="px-2 py-1 sm:px-3 md:px-4 md:py-2">
            <div className="flex items-center justify-between gap-2 md:gap-4">
              <div className="flex min-w-0 z-20 items-center gap-2">
                ...
                <NextLink
                  ...
                  className={[
                    "inline-flex min-w-0 items-center rounded-2xl px-3 py-2 text-sm font-extrabold tracking-[0.01em] text-foreground transition hover:bg-[color-mix(in_srgb,var(--background)_50%,white_14%)]",
                ...
                {sessionUser ? (
                  <>
                    ...
                    <GlassButton
                      ...
                      variant="danger"
                      highContext
                      className="text-sm! font-semibold tracking-wide text-background!"
                      disabled={isNavigating}
                    >
                      Sign Out
                    </GlassButton>
