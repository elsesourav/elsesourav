    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      <div className="max-w-md w-full text-center space-y-6 p-8 rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] backdrop-blur-xl shadow-lg">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-[hsl(var(--foreground))]">Unable to load notes</h2>
          <p className="text-xs text-[hsl(var(--muted-foreground))] leading-relaxed">
            We encountered a problem while retrieving published engineering notes. Please try
            refreshing.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Button
            onClick={() => reset()}
            className="w-full sm:w-auto text-xs bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] gap-1.5"
          >
