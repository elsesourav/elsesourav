...
export const fixtureStandardUser: User = {
  ...
  username: 'alexrivers',
  photoUrl: 'https://res.cloudinary.com/elsesourav/image/upload/v2/avatars/user-1.png',
...
export const fixtureStaffUser: User = {
  ...
  username: 'jordant',
  photoUrl: 'https://res.cloudinary.com/elsesourav/image/upload/v2/avatars/staff.png',
