...
export const ErrorState = React.forwardRef<HTMLDivElement, ErrorStateProps>(
  (
    ...
    const resolvedMessage =
      description || message || 'An unexpected error occurred while loading this content.';
    ...
    return (
      <div ref={ref} role="alert" className={cn('ui-error-state', className)} {...props}>
        ...
        {resolvedMessage && <p className="ui-error-state__message">{resolvedMessage}</p>}
        {(action || onRetry || children) && (
