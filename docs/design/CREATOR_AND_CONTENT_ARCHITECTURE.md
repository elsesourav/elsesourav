...
_Technical framework details belong in the Blog devlogs, about architecture sections, or repository READMEs—not as the primary customer-facing value proposition on the homepage._
